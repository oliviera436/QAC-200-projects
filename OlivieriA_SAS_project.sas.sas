...
DATE: Tuesday, January 13, 2015     TIME: 1:52:16 PM
PROJECT: OlivieriA_SAS_project_01132015
PROJECT PATH: P:\QAC\qac200\students\aolivieri\Assignments\OlivieriA_SAS_project_01132015.egp
---------------------------------------- */
...
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\aolivieri\Assignments\OlivieriA_SAS_project_01132015.egp';
%LET _CLIENTPROJECTNAME='OlivieriA_SAS_project_01132015.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:02 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:03 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:05 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:06 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:07 PM
...
GOPTIONS ACCESSIBLE;
%_eg_conditional_dropds(MEPS.INFULLYR);

PROC SQL;
   CREATE TABLE MEPS.INFULLYR(label="INFULLYR") AS 
   SELECT t1.ADAPPT42, 
          t1.ADCAPE42, 
          t1.ADCLIM42, 
          t1.CANCERDX, 
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:08 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:09 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:10 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:11 PM
...
/*   START OF NODE: INER QUERY   */
LIBNAME EC100025 "P:\QAC\qac200\Data\MEPS";


%LET _CLIENTTASKLABEL='INER QUERY';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\aolivieri\Assignments\OlivieriA_SAS_project_01132015.egp';
%LET _CLIENTPROJECTNAME='OlivieriA_SAS_project_01132015.egp';

GOPTIONS ACCESSIBLE;
%_eg_conditional_dropds(MEPS.INER);

PROC SQL;
   CREATE TABLE MEPS.INER(label="INER") AS 
   SELECT t1.DUID, 
          t1.PID, 
          t1.DUPERSID, 
          t1.EVNTIDX, 
...
/*   START OF NODE: FULL_JOIN_INFULLYR_INER   */
%LET _CLIENTTASKLABEL='FULL_JOIN_INFULLYR_INER';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\aolivieri\Assignments\OlivieriA_SAS_project_01132015.egp';
%LET _CLIENTPROJECTNAME='OlivieriA_SAS_project_01132015.egp';

GOPTIONS ACCESSIBLE;
%_eg_conditional_dropds(MEPS.FULL_JOIN_INER_INFULLYR);

PROC SQL;
   CREATE TABLE MEPS.FULL_JOIN_INER_INFULLYR(label="FULL_JOIN_INER_INFULLYR") AS 
   SELECT t1.ADAPPT42, 
          t1.ADCAPE42, 
          t1.ADCLIM42, 
          t1.CANCERDX, 
          ...
          t2.VARPSU, 
          t2.INER
      FROM MEPS.INFULLYR t1
           FULL JOIN MEPS.INER t2 ON (t1.DUPERSID = t2.DUPERSID)
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:12 PM
   By task: List Data

   Input Data: Local:MEPS.FULL_JOIN_INER_INFULLYR
   Server:  Local
   ------------------------------------------------------------------- */

%_eg_conditional_dropds(WORK.SORTTempTableSorted);
/* -------------------------------------------------------------------
   Sort data set Local:MEPS.FULL_JOIN_INER_INFULLYR
   ------------------------------------------------------------------- */

PROC SQL;
	CREATE VIEW WORK.SORTTempTableSorted AS
		SELECT T.DUPERSID, T.DUPERSID1, T.INER
	FROM MEPS.FULL_JOIN_INER_INFULLYR as T
;
QUIT;
TITLE;
...
%_eg_conditional_dropds(WORK.CONTContentsForFULL_JOIN_INER_IN);
TITLE;
FOOTNOTE;
FOOTNOTE1 "Generated by the SAS System (&_SASSERVERNAME, &SYSSCPL) on %TRIM(%QSYSFUNC(DATE(), NLDATE20.)) at %TRIM(%SYSFUNC(TIME(), TIMEAMPM12.))";
PROC FORMAT;
...
PROC DATASETS NOLIST NODETAILS; 
   CONTENTS DATA=MEPS.FULL_JOIN_INER_INFULLYR OUT=WORK.SUCOUT1;

RUN;

DATA WORK.CONTContentsForFULL_JOIN_INER_IN(LABEL="Contents Details for FULL_JOIN_INER_INFULLYR");
   SET WORK.SUCOUT1;
RUN;
...
CREATE VIEW WORK.SCVIEW AS 
	SELECT DISTINCT memname LABEL="Table Name", 
			...
			charset LABEL="Char. Set", 
			protect LABEL="Password Protected", 
			typemem LABEL="Data Set Type" FROM WORK.CONTContentsForFULL_JOIN_INER_IN
	ORDER BY memname ; 

CREATE TABLE WORK.SCTABLE AS
	SELECT * FROM WORK.SCVIEW
		WHERE memname='FULL_JOIN_INER_INFULLYR';
QUIT;
...
PROC SORT DATA=WORK.CONTContentsForFULL_JOIN_INER_IN OUT=WORK.CONTContentsForFULL_JOIN_INER_IN;
   BY memname name;
RUN;
...
DROP TABLE WORK.SCTABLE;
CREATE TABLE WORK.SCTABLE AS
	SELECT * FROM WORK.CONTContentsForFULL_JOIN_INER_IN
		WHERE memname='FULL_JOIN_INER_INFULLYR';
QUIT;
...
/*   START OF NODE: Recode MRI and XRAY   */
%LET _CLIENTTASKLABEL='Recode MRI and XRAY';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\aolivieri\Assignments\OlivieriA_SAS_project_01132015.egp';
%LET _CLIENTPROJECTNAME='OlivieriA_SAS_project_01132015.egp';

GOPTIONS ACCESSIBLE;
%_eg_conditional_dropds(MEPS.RECODE_INER_INFULLYR);

PROC SQL;
   CREATE TABLE MEPS.RECODE_INER_INFULLYR(label="RECODE_INER_INFULLYR") AS 
   SELECT t1.ADAPPT42, 
          t1.ADCAPE42, 
          t1.ADCLIM42, 
          t1.CANCERDX, 
          ...
          /* XRAY_RECODE */
            (CASE 
               ...
               ELSE t1.XRAYS
            END) LABEL="Xray recode 95=2" AS XRAY_RECODE
      FROM MEPS.FULL_JOIN_INER_INFULLYR t1;
QUIT;
...
/*   START OF NODE: One-Way Frequencies recode   */
%LET _CLIENTTASKLABEL='One-Way Frequencies recode';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\aolivieri\Assignments\OlivieriA_SAS_project_01132015.egp';
%LET _CLIENTPROJECTNAME='OlivieriA_SAS_project_01132015.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:13 PM
   By task: One-Way Frequencies recode

   Input Data: Local:MEPS.RECODE_INER_INFULLYR
   Server:  Local
   ------------------------------------------------------------------- */

%_eg_conditional_dropds(WORK.SORT);
/* -------------------------------------------------------------------
   Sort data set Local:MEPS.RECODE_INER_INFULLYR
   ------------------------------------------------------------------- */

PROC SQL;
	CREATE VIEW WORK.SORT AS
		SELECT T.XRAY_RECODE, T.MRI_RECODE
	FROM MEPS.RECODE_INER_INFULLYR(FIRSTOBS=1 ) as T
;
QUIT;
...
PROC FREQ DATA=WORK.SORT
	ORDER=INTERNAL
;
	TABLES XRAY_RECODE /  SCORES=TABLE;
...
/*   START OF NODE: COUNT_DUPERSID   */
%LET _CLIENTTASKLABEL='COUNT_DUPERSID';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\aolivieri\Assignments\OlivieriA_SAS_project_01132015.egp';
%LET _CLIENTPROJECTNAME='OlivieriA_SAS_project_01132015.egp';

GOPTIONS ACCESSIBLE;
%_eg_conditional_dropds(WORK.QUERY_FOR_FULL_JOIN_INER_INFULLY);

PROC SQL;
   CREATE TABLE WORK.QUERY_FOR_FULL_JOIN_INER_INFULLY AS 
...
/*   START OF NODE: INNERJOIN_ER _VISITS   */
%LET _CLIENTTASKLABEL='INNERJOIN_ER _VISITS';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\aolivieri\Assignments\OlivieriA_SAS_project_01132015.egp';
%LET _CLIENTPROJECTNAME='OlivieriA_SAS_project_01132015.egp';

GOPTIONS ACCESSIBLE;
%_eg_conditional_dropds(WORK.INNER_JOIN_ERVISITS);

PROC SQL;
   CREATE TABLE WORK."INNER_JOIN_ERVISITS"n AS 
   SELECT t1.COUNT_of_DUPERSID, 
          t1.DUPERSID1, 
          t2.ADAPPT42, 
          t2.ADCAPE42, 
          t2.ADCLIM42, 
          ...
          t2.HEALTH_LIMITS_MOD_ACTIVITIES, 
          t2.HLTH_LIMITS_STAIRS, 
          t2.ACCMP_LESS_PHY, 
          t2.WORK_LIMIT_PHY, 
          t2.ACCMP_LESS_MNT, 
          t2.WORK_LIMIT_MNT, 
          ...
          t2.'HAD_ALOT_ ENRGY'n, 
          t2.FELT_DOWNHEARTED_DEPR, 
          t2.HLTH_STOPPED_SOC_ACTIV, 
          t2.MARITAL_STATUS, 
          t2.MARITAL_STATUS_W_SPOUSE, 
          t2.YEARS_EDU_FIRST_ENTER_MEPS, 
          t2.YEARS_EDU_HIGHEST_DEGREE, 
          t2.HIGHEST_DEGREE_FIRST_ENTERED, 
          t2.EMPLOYMENT_STATUS_3_1, 
          t2.EMPLOYMENT_STATUS_4_2, 
          t2.EMPLOYMENT_STATUS_5_3, 
          t2.CURRENTLY_SMOKE, 
          t2.EASY_GETTING_MED_CARE, 
          t2.NEED_CARE_TEST_TREATMENT, 
          t2.ILL_INJURY_IMMED_CARE, 
          t2.MORE_LIKELY_TAKE_RISKS, 
          t2.CAN_OVERCOME_ILLS_WO_MED, 
          t2.OVERALL_RATING_FEELINGS, 
          t2.HOW_OFTEN_FELT_NERVOUS, 
          t2.VISITS_TO_MED_OFF, 
          t2.GOT_MED_APPT_WHEN_WANTED, 
          t2.OTHER_HEART_DISEASE_DIAG, 
          t2.CANCER_DIAGNOSIS, 
          t2.EMPHYSEMA_DIAGNOSIS, 
          t2.HEART_ATTACK_DIAG, 
          t2.CORONARY_HRT_DISEASE_DIAG, 
          t2.HIGH_BLOOD_PRESSURE_DIAG, 
          t2.STROKE_DIAG, 
          t2.PERSON_IS_FLAGGED_DEPENDENT, 
          t2.NEVER_BEEN_SERIOUSLY_ILL, 
          t2.'WORRY_MORE _ABOUT_HEALTH'n, 
          t2.ADGEN42_reverse, 
          t2.ADPAIN42_reverse, 
          t2.ADCAPE42_reverse, 
          t2.ADNRGY42_reverse, 
          ...
          t2.MRI_RECODE, 
          t2.XRAY_RECODE
      FROM WORK.QUERY_FOR_FULL_JOIN_INER_INFULLY t1
           INNER JOIN MEPS.RECODE_INER_INFULLYR t2 ON (t1.DUPERSID1 = t2.DUPERSID1);
QUIT;
...
/*   START OF NODE: Frequencies Count DUPERSID    */
%LET _CLIENTTASKLABEL='Frequencies Count DUPERSID ';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\aolivieri\Assignments\OlivieriA_SAS_project_01132015.egp';
%LET _CLIENTPROJECTNAME='OlivieriA_SAS_project_01132015.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:14 PM
   By task: Frequencies Count DUPERSID 

   Input Data: Local:WORK.INNER_JOIN_ERVISITS
   Server:  Local
   ------------------------------------------------------------------- */

%_eg_conditional_dropds(WORK.SORT);
/* -------------------------------------------------------------------
   Sort data set Local:WORK.INNER_JOIN_ERVISITS
   ------------------------------------------------------------------- */

PROC SQL;
	CREATE VIEW WORK.SORT AS
		SELECT T.COUNT_of_DUPERSID
	FROM WORK.INNER_JOIN_ERVISITS as T
;
QUIT;
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:15 PM
...
/*   START OF NODE: ER_VISITS_CATEGORICAL   */
%LET _CLIENTTASKLABEL='ER_VISITS_CATEGORICAL';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\aolivieri\Assignments\OlivieriA_SAS_project_01132015.egp';
%LET _CLIENTPROJECTNAME='OlivieriA_SAS_project_01132015.egp';

GOPTIONS ACCESSIBLE;
%_eg_conditional_dropds(WORK.ER_VISITS_CATEGORICAL);

PROC SQL;
   CREATE TABLE WORK."ER_VISITS_CATEGORICAL"n AS 
   SELECT t1.COUNT_of_DUPERSID, 
          t1.DUPERSID1, 
          t1.ADAPPT42, 
          t1.ADCAPE42, 
          ...
          /* ER_VISITS_CATEGORICAL */
            (CASE  
               ...
               THEN 3
               ELSE 4
            END) LABEL="ER visits categorical three categories" AS ER_VISITS_CATEGORICAL
      FROM WORK.INNER_JOIN_ERVISITS t1;
QUIT;
...
/*   START OF NODE: Table Analysis DUPERSID_AND_CATEGORICAL_ER   */
%LET _CLIENTTASKLABEL='Table Analysis DUPERSID_AND_CATEGORICAL_ER';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\aolivieri\Assignments\OlivieriA_SAS_project_01132015.egp';
%LET _CLIENTPROJECTNAME='OlivieriA_SAS_project_01132015.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:16 PM
   By task: Table Analysis DUPERSID_AND_CATEGORICAL_ER

   Input Data: Local:WORK.ER_VISITS_CATEGORICAL
   Server:  Local
   ------------------------------------------------------------------- */

%_eg_conditional_dropds(WORK.SORTTempTableSorted);
/* -------------------------------------------------------------------
   Sort data set Local:WORK.ER_VISITS_CATEGORICAL
   ------------------------------------------------------------------- */

PROC SQL;
	CREATE VIEW WORK.SORTTempTableSorted AS
		SELECT T.ER_VISITS_CATEGORICAL, T.COUNT_of_DUPERSID
	FROM WORK.ER_VISITS_CATEGORICAL as T
;
QUIT;
TITLE;
TITLE1 "Table Analysis";
...
PROC FREQ DATA = WORK.SORTTempTableSorted
	ORDER=INTERNAL
;
	TABLES COUNT_of_DUPERSID * ER_VISITS_CATEGORICAL /
		NOROW
		NOPERCENT
		NOCUM
		SCORES=TABLE
...
/*   START OF NODE: Frequencies_CATEGORICAL   */
%LET _CLIENTTASKLABEL='Frequencies_CATEGORICAL';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\aolivieri\Assignments\OlivieriA_SAS_project_01132015.egp';
%LET _CLIENTPROJECTNAME='OlivieriA_SAS_project_01132015.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Tuesday, January 13, 2015 at 1:51:16 PM
   By task: Frequencies_CATEGORICAL
...
PROC SQL;
	CREATE VIEW WORK.SORT AS
		SELECT T.ER_VISITS_CATEGORICAL
	FROM WORK.ER_VISITS_CATEGORICAL as T
;
QUIT;
...
PROC FREQ DATA=WORK.SORT
	ORDER=INTERNAL
;
	TABLES ER_VISITS_CATEGORICAL /  SCORES=TABLE;
RUN;
/* -------------------------------------------------------------------
   End of task code.
   ------------------------------------------------------------------- */
